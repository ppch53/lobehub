export default {
  ...
  'geminiCliInstallGuide.actions.openDocs': 'Open Install Guide',
  'geminiCliInstallGuide.actions.openSystemTools': 'Open System Tools',
  'geminiCliInstallGuide.afterInstall':
    'After installing, run Gemini once to sign in, then retry your message or click Re-detect in System Tools.',
  'geminiCliInstallGuide.desc':
    'Gemini CLI needs the gemini command to run on this machine. Install it and make sure the gemini command is available in your PATH.',
  'geminiCliInstallGuide.installWithBrew': 'Sign in command',
  'geminiCliInstallGuide.installWithNpm': 'Recommended install',
  'geminiCliInstallGuide.menuNotification.title': 'Gemini CLI not found',
  'geminiCliInstallGuide.reason': 'LobeHub could not start Gemini CLI: {{message}}',
  'geminiCliInstallGuide.title': 'Install Gemini CLI',
  'newAgent': 'Create Agent',
  'newClaudeCodeAgent': 'Add Claude Code',
  'newCodexAppAgent': 'Add Codex App Server',
  'newCodexAgent': 'Add Codex',
  'newGeminiCliAgent': 'Add Gemini CLI',
